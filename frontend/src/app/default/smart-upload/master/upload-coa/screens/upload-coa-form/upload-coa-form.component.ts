...
@Component({
  selector: 'app-upload-coa-form',
  templateUrl: './upload-coa-form.component.html',
  styleUrls: ['./upload-coa-form.component.scss']
})
export class UploadCOAFormComponent implements OnInit {
  submitted = false;
