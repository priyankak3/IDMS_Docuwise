...
@Component({
  selector: 'app-upload-tds-form',
  templateUrl: './upload-tds-form.component.html',
  styleUrls: ['./upload-tds-form.component.scss']
})
export class UploadTDSFormComponent implements OnInit {
  submitted = false;
