...
export class BOMOfProductService {
  routes: any = {
    ...
    getAllMasterDataPath:
      '/planning/billOfMaterial/BoMOfProduct/getAllMasterData',
    updatePath: (id: string) =>
      `/planning/billOfMaterial/BoMOfProduct/update/${id}`,
    getByIdPath: (id: string) =>
      `/planning/billOfMaterial/BoMOfProduct/getById/${id}`,
    deletePath: (id: string) =>
      `/planning/billOfMaterial/BoMOfProduct/delete/${id}`,
  };
