...
export class BOMChildPartService {
  routes: any = {
    ...
    getAllMasterDataPath:
      '/planning/billOfMaterial/BoMOfChildPart/getAllMasterData',
    updatePath: (id: string) =>
      `/planning/billOfMaterial/BoMOfChildPart/update/${id}`,
    getByIdPath: (id: string) =>
      `/planning/billOfMaterial/BoMOfChildPart/getById/${id}`,
    deletePath: (id: string) =>
      `/planning/billOfMaterial/BoMOfChildPart/delete/${id}`,
  };
