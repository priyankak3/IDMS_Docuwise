...
export class BOMGrandChildItemService {
  routes: any = {
    ...
    getAllMasterDataPath:
      '/planning/billOfMaterial/BoMOfGrandChildItem/getAllMasterData',
    updatePath: (id: string) =>
      `/planning/billOfMaterial/BoMOfGrandChildItem/update/${id}`,
    getByIdPath: (id: string) =>
      `/planning/billOfMaterial/BoMOfGrandChildItem/getById/${id}`,
    deletePath: (id: string) =>
      `/planning/billOfMaterial/BoMOfGrandChildItem/delete/${id}`,
  };
