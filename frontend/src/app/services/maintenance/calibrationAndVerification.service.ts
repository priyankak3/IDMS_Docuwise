...
export class CalibrationAndVerificationService {
  routes: any = {
    ...
    getAllDNSummaryReportsPath:
      '/maintenance/calibrationAndVerification/getAllDNSummaryReports',
    getAllDNDetailsReportsPath:
      '/maintenance/calibrationAndVerification/getAllDNDetailsReports',
    getAllMasterDataPath:
      '/maintenance/calibrationAndVerification/getAllMasterData',
    excelDownloadPath:
      '/maintenance/calibrationAndVerification/excelDownloadForReports',
    excelDownloadPPVpath:
      '/maintenance/calibrationAndVerification/excelDownloadForPPVReports',
    updatePath: (id: string) =>
      `/maintenance/calibrationAndVerification/update/${id}`,
    ...
    getByIdPath: (id: string) =>
      `/maintenance/calibrationAndVerification/getById/${id}`,
    getDNDetailsByIdPath: (id: string) =>
      `/maintenance/calibrationAndVerification/getDNDetailsById/${id}`,
    deletePath: (id: string) =>
      `/maintenance/calibrationAndVerification/delete/${id}`,
  };
