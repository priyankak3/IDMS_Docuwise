...
export class AppParameterService {
  routes: any = {
    ...
    excelDownloadPath: '/settings/appParameter/excelDownload',
    updatePath: (id: string) => `/settings/appParameter/update/${id}`,
    getByIdPath: (id: string) => `/settings/appParameter/getById/${id}`,
    getAppParameterValueByCodePath: (code: string) =>
      `/settings/appParameter/getAppParameterValueByCode/${code}`,
    deletePath: (id: string) => `/settings/appParameter/delete/${id}`,
  };
  ...
  getAppParameterValueByCode(code: string) {
    return this.http
      .get(this.routes.getAppParameterValueByCodePath(code))
      .pipe(map((res: any) => res));
  }
  delete(id: string) {
    return this.http
