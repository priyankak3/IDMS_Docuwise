...
export class PayrollService {
    routes: any = {
        ...
        getAllSalarySlipReportsPath: "/hr/payroll/getAllSalarySlipReports",
        getByIdForSlipPath: (id: string) => `/hr/payroll/getByIdForSlip/${id}`
    };
    ...
    getAllSalarySlipReports(params: any) {
        return this.http.get(this.routes.getAllSalarySlipReportsPath, params).pipe(map((res: any) => res));
    }
    getByIdForSlip(id: string) {
        return this.http.get(this.routes.getByIdForSlipPath(id)).pipe(map((res: any) => res));
    }
}
