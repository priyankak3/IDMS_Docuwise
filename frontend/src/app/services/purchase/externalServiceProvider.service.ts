...
export class ExternalServiceProviderService {
  routes: any = {
    ...
    excelDownloadPath: '/purchase/externalServiceProvider/excelDownload',
    updatePath: (id: string) =>
      `/purchase/externalServiceProvider/update/${id}`,
    getByIdPath: (id: string) =>
      `/purchase/externalServiceProvider/getById/${id}`,
    deletePath: (id: string) =>
      `/purchase/externalServiceProvider/delete/${id}`,
  };
