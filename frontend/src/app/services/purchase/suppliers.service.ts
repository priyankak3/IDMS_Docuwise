...
export class SuppliersService {
    routes: any = {
        ...
        excelDownloadPath: "/purchase/supplierMaster/excelDownload",
    ...
    uploadSupplierFile(payload: any) {
        return this.http.post(this.routes.uploadSupplierFilePath, payload);
    }
    uploadAndCheckCSVFile(payload: any) {
        return this.http.post(this.routes.uploadAndCheckCSVFilePath, payload);
    }
    bulkInsertByCSVFile(payload: any) {
        return this.http.post(this.routes.bulkInsertByCSVFilePath, payload);
    }
    create(payload: any) {
