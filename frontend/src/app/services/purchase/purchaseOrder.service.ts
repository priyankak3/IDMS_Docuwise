...
export class PurchaseOrderService {
  routes: any = {
    ...
    excelDownloadPath: '/purchase/po/excelDownloadForReports',
    ...
    getAllPOStatusReportsPath: '/purchase/po/getAllPOStatusReports',
    ...
    updatePODetailsLineStatusByIdPath: (id: string) =>
      `/purchase/po/updatePODetailsLineStatusById/${id}`,
  ...
  getAllPOSummaryReports(params: any) {
    return this.http
      .get(this.routes.getAllPOSummaryReportsPath, params)
      .pipe(map((res: any) => res));
  }
  getAllPOCostAnalysisReports(params: any) {
    return this.http
      .get(this.routes.getAllPOCostAnalysisReportsPath, params)
      .pipe(map((res: any) => res));
  }
  getAllPOStatusReports(params: any) {
    return this.http
      .get(this.routes.getAllPOStatusReportsPath, params)
      .pipe(map((res: any) => res));
  }
  getAllPPVSummaryReports(params: any) {
    return this.http
      .get(this.routes.getAllPPVSummaryReportsPath, params)
      .pipe(map((res: any) => res));
  }
  getAllPPVReportsBySupplier(params: any) {
    return this.http
      .get(this.routes.getAllPPVReportsBySupplierPath, params)
      .pipe(map((res: any) => res));
  }
  getAllPPVDetailsReports(params: any) {
    return this.http
      .get(this.routes.getAllPPVDetailsReportsPath, params)
      .pipe(map((res: any) => res));
  }

  getAllOutstandingPOReport(params: any) {
    return this.http
      .get(this.routes.getAllOutstandingPOReportPath, params)
      .pipe(map((res: any) => res));
  }
  ...
  getPODetailsById(id: string) {
    return this.http
      .get(this.routes.getPODetailsByIdPath(id))
      .pipe(map((res: any) => res));
  }
  delete(id: string) {
    return this.http
  ...
  getAllShortPOForClosing(params: any) {
    return this.http
      .get(this.routes.getAllShortPOForClosingPath, params)
      .pipe(map((res: any) => res));
  }
  updatePODetailsLineStatusById(id: string, payload: any) {
    return this.http
      .put(this.routes.updatePODetailsLineStatusByIdPath(id), payload)
      .pipe(map((res: any) => res));
  }
  getAllItemsForSupplier(params: any) {
    return this.http
      .get(this.routes.getAllItemsForSupplierPath, params)
      .pipe(map((res: any) => res));
  }
}
