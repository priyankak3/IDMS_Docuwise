...
export class DebitNoteService {
  routes: any = {
    ...
    getAllDNDetailsReportsPath: '/purchase/debitNote/getAllDNDetailsReports',
    getAllMasterDataPath: '/purchase/debitNote/getAllMasterData',
    excelDownloadPath: '/purchase/debitNote/excelDownloadForReports',
    excelDownloadPPVpath: '/purchase/debitNote/excelDownloadForPPVReports',
    updatePath: (id: string) => `/purchase/debitNote/update/${id}`,
    getAllDebitNoteBySupplierIdPath: (id: string) =>
      `/purchase/debitNote/getAllDebitNoteBySupplierId/${id}`,
    getByIdPath: (id: string) => `/purchase/debitNote/getById/${id}`,
    getDNDetailsByIdPath: (id: string) =>
      `/purchase/debitNote/getDNDetailsById/${id}`,
