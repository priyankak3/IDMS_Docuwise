...
export class GoodsRequisitionService {
  routes: any = {
    ...
    excelDownloadPath: '/production/goodsRequisition/excelDownload',
    getAllGRSummaryReportsPath:
      '/production/goodsRequisition/getAllGRSummaryReports',
    getAllGRDetailsReportsPath:
      '/production/goodsRequisition/getAllGRDetailsReports',
    ...
    getAllGRFulfillmentReportsPath:
      '/production/goodsRequisition/getAllGRFulfillmentReports',
  };
  ...
  getAllGRSummaryReports(params: any) {
    return this.http
      .get(this.routes.getAllGRSummaryReportsPath, params)
      .pipe(map((res: any) => res));
  }
  getAllGRDetailsReports(params: any) {
    return this.http
      .get(this.routes.getAllGRDetailsReportsPath, params)
      .pipe(map((res: any) => res));
  }
  ...
  getAllGRFulfillmentReports(params: any) {
    return this.http
      .get(this.routes.getAllGRFulfillmentReportsPath, params)
      .pipe(map((res: any) => res));
  }
}
