...
export class PDIREntryService {
  routes: any = {
    ...
    getProductSpecificationBySKUIdPath:
      '/quality/PDIREntry/getProductSpecificationBySKUId',
    getAllReportPath: '/quality/PDIREntry/getAllReports',
    getAllMasterDataPath: '/quality/PDIREntry/getAllMasterData',
    getAllSalesInvoiceForPDIREntryPath:
      '/quality/PDIREntry/getAllSalesInvoiceForPDIREntry',
    excelDownloadPath: '/quality/PDIREntry/excelDownload',
    updatePath: (id: string) => `/quality/PDIREntry/update/${id}`,
    getPDIRDetailsBySalesInvoiceIdPath: (id: string) =>
      `/quality/PDIREntry/getPDIRDetailsBySalesInvoiceId/${id}`,
    getByIdPath: (id: string) => `/quality/PDIREntry/getById/${id}`,
    getPDIRDetailsByIdPath: (id: string) =>
      `/quality/PDIREntry/getPDIRDetailsById/${id}`,
  ...
  getProductSpecificationBySKUId(params: any) {
    return this.http
      .get(this.routes.getProductSpecificationBySKUIdPath, params)
      .pipe(map((res: any) => res));
  }
  ...
  getAllSalesInvoiceForPDIREntry(params: any) {
    return this.http
      .get(this.routes.getAllSalesInvoiceForPDIREntryPath, params)
      .pipe(map((res: any) => res));
  }
  ...
  getPDIRDetailsById(id: string) {
    return this.http
      .get(this.routes.getPDIRDetailsByIdPath(id))
      .pipe(map((res: any) => res));
  }
  getPDIRDetailsBySalesInvoiceId(id: string) {
    return this.http
      .get(this.routes.getPDIRDetailsBySalesInvoiceIdPath(id))
      .pipe(map((res: any) => res));
  }
  delete(id: string) {
    return this.http
