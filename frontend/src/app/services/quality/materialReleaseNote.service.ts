...
export class MaterialReleaseNoteService {
  routes: any = {
    ...
    excelDownloadPath: '/quality/mrn/excelDownload',
    getAllReportsPath: '/quality/mrn/getAllReports',
    getAllSupplierWiseReportsPath: '/quality/mrn/getAllSupplierWiseReports',
    getAllGRNvsMRNReportsPath: '/quality/mrn/getAllGRNvsMRNReports',
    getAllMRNRejectionReportsPath: '/quality/mrn/getAllMRNRejectionReports',
    getAllItemWiseReportsPath: '/quality/mrn/getAllItemWiseReports',
    getAllRawMaterialInspectionReportsPath:
      '/quality/mrn/getAllRawMaterialInspectionReports',
    ...
    getMRNDetailsByIdPath: (id: string) =>
      `/quality/mrn/getMRNDetailsById/${id}`,
  ...
  getRMSpecificationByItemId(params: any) {
    return this.http
      .get(this.routes.getRMSpecificationByItemIdPath, params)
      .pipe(map((res: any) => res));
  }
  ...
  getAllGRNvsMRNReports(params: any) {
    return this.http
      .get(this.routes.getAllGRNvsMRNReportsPath, params)
      .pipe(map((res: any) => res));
  }
  getAllMRNRejectionReports(params: any) {
    return this.http
      .get(this.routes.getAllMRNRejectionReportsPath, params)
      .pipe(map((res: any) => res));
  }
  ...
  getAllRawMaterialInspectionReports(params: any) {
    return this.http
      .get(this.routes.getAllRawMaterialInspectionReportsPath, params)
      .pipe(map((res: any) => res));
  }
  getByMRNIdForRMInspection(params: any) {
    return this.http
      .get(this.routes.getByMRNIdForRMInspectionPath, params)
      .pipe(map((res: any) => res));
  }
  ...
  getMRNDetailsById(id: string) {
    return this.http
      .get(this.routes.getMRNDetailsByIdPath(id))
      .pipe(map((res: any) => res));
  }
  delete(id: string) {
    return this.http
