...
export class ProformaInvoiceService {
  routes: any = {
    ...
    excelDownloadPath: '/sales/proformaInvoice/excelDownload',
    getAllCancelProformaInvoice:
      '/sales/proformaInvoice/getAllCancelProformaInvoice',
    updatePath: (id: string) => `/sales/proformaInvoice/update/${id}`,
    getByIdPath: (id: string) => `/sales/proformaInvoice/getById/${id}`,
    getProInvDetailsByIdPath: (id: string) =>
      `/sales/proformaInvoice/getProInvDetailsById/${id}`,
  ...
  getProInvDetailsById(id: string) {
    return this.http
      .get(this.routes.getProInvDetailsByIdPath(id))
      .pipe(map((res: any) => res));
  }
  delete(id: string) {
    return this.http
