...
export class SKUService {
  routes: any = {
    ...
    getAllSKUReportsPath: '/sales/SKU/getAllReports',
    getAllReportPath: '/sales/salesOrder/getAllReports',
    excelDownloadPath: '/sales/SKU/excelDownload',
    ...
    getAllSKUMasterBySKUIdPath: (id: string) =>
      `/sales/SKU/getAllSKUMasterBySKUId/${id}`,
  };
  ...
  getAllSKUReports(params: any) {
    return this.http
      .get(this.routes.getAllSKUReportsPath, params)
      .pipe(map((res: any) => res));
  }
  ...
  getAllSKUMasterBySKUId(id: string) {
    return this.http
      .get(this.routes.getAllSKUMasterBySKUIdPath(id))
      .pipe(map((res: any) => res));
  }
  getAllSKUForCostEstimation(params: any) {
    return this.http
      .get(this.routes.getAllSKUForCostEstimationPath, params)
      .pipe(map((res: any) => res));
  }
}
