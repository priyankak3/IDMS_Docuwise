...
export class GoodsIssueService {
  routes: any = {
    ...
    excelDownloadPath: '/stores/goodsIssue/excelDownload',
    updateOnResolveDiscrepancyPath: (id: string) =>
      `/stores/goodsIssue/updateOnResolveDiscrepancy/${id}`,
    updatePath: (id: string) => `/stores/goodsIssue/update/${id}`,
    getByIdPath: (id: string) => `/stores/goodsIssue/getById/${id}`,
    getGoodRequisitionByIdPath: (id: string) =>
      `/stores/goodsIssue/getGoodRequisitionById/${id}`,
  ...
  updateOnResolveDiscrepancy(id: string, payload: any) {
    return this.http
      .put(this.routes.updateOnResolveDiscrepancyPath(id), payload)
      .pipe(map((res: any) => res));
  }
  ...
  getGoodRequisitionById(id: string) {
    return this.http
      .get(this.routes.getGoodRequisitionByIdPath(id))
      .pipe(map((res: any) => res));
  }
}
