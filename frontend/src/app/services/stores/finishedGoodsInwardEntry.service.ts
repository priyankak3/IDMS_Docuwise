...
export class FinishedGoodsInwardEntryService {
  routes: any = {
    ...
    getAllFGINDetailsReportsPath: '/stores/FGIN/getAllFGINDetailsReports',
    getAllFGINLocationWiseReportsPath:
      '/stores/FGIN/getAllFGINLocationWiseReports',
    getAllFGINAllLocationReportsPath:
      '/stores/FGIN/getAllFGINAllLocationReports',
  ...
  getAllFGINSummaryReports(params: any) {
    return this.http
      .get(this.routes.getAllFGINSummaryReportsPath, params)
      .pipe(map((res: any) => res));
  }
  getAllFGINDetailsReports(params: any) {
    return this.http
      .get(this.routes.getAllFGINDetailsReportsPath, params)
      .pipe(map((res: any) => res));
  }
  getAllFGINLocationWiseReports(params: any) {
    return this.http
      .get(this.routes.getAllFGINLocationWiseReportsPath, params)
      .pipe(map((res: any) => res));
  }
  getAllFGINByProductCategory(params: any) {
    return this.http
      .get(this.routes.getAllFGINByProductCategoryPath, params)
      .pipe(map((res: any) => res));
  }
  getAllFGINAllLocationReports(params: any) {
    return this.http
      .get(this.routes.getAllFGINAllLocationReportsPath, params)
      .pipe(map((res: any) => res));
  }
  ...
  bulkCreate(payload: any) {
    return this.http
      .post(this.routes.bulkCreatePath, payload)
      .pipe(map((res: any) => res));
  }
  getAllFGINValueFinanceReports(params: any) {
    return this.http
      .get(this.routes.getAllFGINValueReportsPath, params)
      .pipe(map((res: any) => res));
  }
}
