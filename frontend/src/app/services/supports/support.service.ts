...
export class SupportService {
  routes: any = {
    ...
    excelDownloadPath: '/supports/issue/excelDownload',
    updatePath: (id: string) => `/supports/issue/update/${id}`,
    getAllSubModuleListByMenuIdPath: (id: string) =>
      `/supports/issue/getAllSubModuleListByMenuId/${id}`,
  ...
  getAllSubModuleListByMenuId(id: string) {
    return this.http
      .get(this.routes.getAllSubModuleListByMenuIdPath(id))
      .pipe(map((res: any) => res));
  }
  getById(id: string) {
    return this.http
