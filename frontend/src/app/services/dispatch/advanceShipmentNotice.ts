...
export class AdvanceShipmentNotice {
  routes: any = {
    ...
    excelDownloadPath: '/dispatch/advanceShipmentNotice/excelDownload',
    getAllShipmentSummaryReportsPath:
      '/dispatch/advanceShipmentNotice/getAllShipmentSummaryReports',
    updatePath: (id: string) => `/dispatch/advanceShipmentNotice/update/${id}`,
    getByIdPath: (id: string) =>
      `/dispatch/advanceShipmentNotice/getById/${id}`,
    sendMailByIdPath: (id: string) =>
      `/dispatch/advanceShipmentNotice/sendMailById/${id}`,
    getASNDetailsByIdPath: (id: string) =>
      `/dispatch/advanceShipmentNotice/getANSDetailsById/${id}`,
  ...
  getAllShipmentSummaryReports(params: any) {
    return this.http
      .get(this.routes.getAllShipmentSummaryReportsPath, params)
      .pipe(map((res: any) => res));
  }
  ASNDetailsBySalesInvoiceId(id: string) {
    return this.http
      .get(this.routes.ASNDetailsBySalesInvoiceIdPath(id))
      .pipe(map((res: any) => res));
  }
  ...
  getASNDetailsById(id: string) {
    return this.http
      .get(this.routes.getASNDetailsByIdPath(id))
      .pipe(map((res: any) => res));
  }
  sendMailById(id: string) {
    return this.http
      .get(this.routes.sendMailByIdPath(id))
      .pipe(map((res: any) => res));
  }
  delete(id: string) {
    return this.http
